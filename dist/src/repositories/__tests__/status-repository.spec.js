...
describe('status', function () {
    ...
    var status = new StatusRepository(mockHttp, '999.0.0', {
        url: 'https://example.com',
    });
    beforeEach(function () {
        mockHttp.clear();
    });
    test('fetch', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, status.fetch('123123')];
                case 1:
                    _a.sent();
    ...
    test('create', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, status.create({
                        status: 'hello',
                    })];
                case 1:
                    _a.sent();
    ...
    test('delete', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, status.remove('123123')];
                case 1:
                    _a.sent();
